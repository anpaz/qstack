...
\subsection{Mid-circuit vs. Post-processing Correction}
...
\begin{itemize}
\item \textbf{qstack}: Implements mid-circuit error correction during evaluation, allowing decoded results to influence subsequent quantum operations.
